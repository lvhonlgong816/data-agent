...
from qdrant_client.conversions.common_types import VectorParams, PointStruct, QueryResponse
...
class ColumnQdrantRepository:
    ...
    async def search(self, embedding: list[float], score: float = 0.7, limit: int = 10):
